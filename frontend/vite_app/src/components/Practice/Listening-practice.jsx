    ...
    <div className="container">
      ...
      <Link to="/practice">
        ...
        <div className="header">
          ...
          <p>Improve your listening skills with our comprehensive practice tests </p>
        </div>
        ...
        <div className="materials-section">
          ...
          <div className="practice-grid">
            {[
              {
                title: "Listening Skills Masterclass",
                description: "Learn advanced Listening techniques by IELTS experts",
                duration: "2 hours",
                level: "All Levels",
              },
              {
              ...
              {
                title: "Speed Listening Course",
                description: "Improve your listening speed and comprehension",
                duration: "3 hours",
                level: "Advanced",
              },
            ].map((material) => (
